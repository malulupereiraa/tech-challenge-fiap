...
import { ButtonProps } from "../../app/@core/types/button";
import ButtonTCF from "../../app/@core/components/button/Button";
...
export default {
  ...
  parameters: {
    ...
    argTypes: {
        ...
        variant: {
            description: 'Button Color. There are: base, orange, dark, dark-outline, green, green-outline,'
        },
        rounded: {
            control: 'boolean',
