import StyledMenuMobile from "@/stories/components/MenuDocs/styles/StyledMenuMobile";
...
export default function MenuMobileDocumentacao() {
  ...
  return (
    <StyledMenuMobile className="row no-gutters menuContainer">
